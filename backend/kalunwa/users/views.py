...
from .permissions import (
    AuthenticatedDoSafeMethodsOnly,
    SuperUserOnly,
    AccountOwnerCanEditDeleteDetailOnly
)
...
class UserListView(ListAPIView):
    ...
    """
    permission_classes = [AuthenticatedDoSafeMethodsOnly] 
...
class UserRetrieveUpdateDestroyView(RetrieveUpdateDestroyAPIView):
    ...
    """
    permission_classes = [SuperUserOnly | AccountOwnerCanEditDeleteDetailOnly
                         | AuthenticatedDoSafeMethodsOnly] 
    queryset = User.objects.all()
    serializer_class = UserSerializer
