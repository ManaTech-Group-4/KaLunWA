...
class SuperUserOnly(BasePermission):
    ...
    def has_permission(self, request, view):
        """
        only superusers can access list. 
        """
...
class AuthenticatedOnlyWithSafeMethods(BasePermission):
    """
    Only Authenticated users are allowed on marked detail views, though they have limitations.
...
class AccountOwnerOnlyCanEditDeleteDetail(BasePermission):
    """
    ...
    def has_object_permission(self, request, view, obj):                      
        # authenticated users can look at user basic info (email etc.)
        ...
        return False      
class OwnersOnlyCanEditDelete(BasePermission):
    """
