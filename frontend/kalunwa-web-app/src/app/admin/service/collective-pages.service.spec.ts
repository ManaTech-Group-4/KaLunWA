...
describe('CollectivePagesService', () => {
  ...
  it('retrieve data from getEventList', () => {
    ...
    const req = httpTestingController.expectOne('http://127.0.0.1:8000/api/events/?omit=image,updated_at,description,end_date');
  ...
  it('retrieve data from getProjectList', () => {
    ...
    const req = httpTestingController.expectOne('http://127.0.0.1:8000/api/projects/?omit=image,updated_at,description,end_date');
  ...
  it('retrieve data from getNewsList', () => {
    ...
    const req = httpTestingController.expectOne('http://127.0.0.1:8000/api/news/?omit=image,updated_at,description,end_date');
  ...
  it('retrieve data from getAnnoucementList', () => {
    ...
    const req = httpTestingController.expectOne('http://127.0.0.1:8000/api/announcements/?updated_at,description,end_date');
